...
def modele(var_team1,var_team2):
	...
	return('Team 1 has ' + str(round(var_team1['Minutes played'].sum()*100/(var_team1['Minutes played'].sum()+var_team2['Minutes played'].sum()))) + ' % chance of winning against team 2 !')
